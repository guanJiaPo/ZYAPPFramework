...
static ZYNetworkManager *_httpManager = nil;

+ (instancetype)shared {
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _httpManager = [[ZYNetworkManager alloc]initWithBaseURL:[NSURL URLWithString:kNetWorkBaseUrl]];
    });
    return _httpManager;
}
...
- (void)post:(NSString *)api params:(NSDictionary *)params responseClass:(Class)clazz showLoading:(BOOL)showLoading respSuccess:(void(^)(ZYResponse *response))respSuccess {
    [self post:api params:params responseClass:clazz showLoading:showLoading success:^(ZYResponse *response) {
        if (response.success) {
        ...
        [MBProgressHUD showRequestFailed];
    }];
}
...
- (void)post:(NSString *)api parameters:(NSDictionary *)parameters showLoading:(BOOL)showLoading loadingMessage:(NSString *)loadingMessage openLog: (BOOL)openLog success:(void(^)(id response))success failure:(void (^)(NSError *error))failure {
    ...
    [self request:ZYRequestMethodPost api:api parameters:parameters showLoading:showLoading loadingMessage:loadingMessage openLog:openLog success:success failure:failure];
}
...
- (void)request:(ZYRequestMethod)method api:(NSString *)api parameters:(NSDictionary *)parameters showLoading:(BOOL)showLoading loadingMessage:(NSString *)loadingMessage openLog: (BOOL)openLog success:(void(^)(id response))success failure:(void(^)(NSError *error))failure {
    ...
    NSString *httpMethod = @"";
    switch (method) {
        case ZYRequestMethodPost:
            httpMethod = @"POST";
            break;
        case ZYRequestMethodGet:
            httpMethod = @"GET";
            break;
        case ZYRequestMethodPatch:
            httpMethod = @"PATCH";
            break;
        case ZYRequestMethodPut:
            httpMethod = @"PUT";
            break;
        default:
            break;
    ...
    NSData *body = [parameters toJSONData];
...
- (void)get:(NSString *)api params:(NSDictionary *)params responseClass:(Class)clazz showLoading:(BOOL)showLoading respSuccess:(void(^)(ZYResponse *response))respSuccess {
    [self get:api params:params responseClass:clazz showLoading:showLoading success:^(ZYResponse *response) {
        if (response.success) {
            respSuccess(response);
        } else {
            [MBProgressHUD showMessage:response.message];
...
- (void)get:(NSString *)api responseClass:(Class)clazz showLoading:(BOOL)showLoading respSuccess:(void(^)(ZYResponse *response))respSuccess {
    [self get:api params:nil responseClass:clazz showLoading:showLoading respSuccess:respSuccess];
}
...
- (void)get:(NSString *)api responseClass:(Class)clazz showLoading:(BOOL)showLoading success:(void(^)(ZYResponse *response))success failure:(void (^)(NSError *error))failure {
    [self get:api params: nil responseClass:clazz showLoading:showLoading success:success failure:failure];
}
