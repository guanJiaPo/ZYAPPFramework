...
- (void)configDefaultValues {
    ...
    _previewItems = 1;
    _sliderHeight = 2;
    _headerHeight = 44 + VTSTATUSBAR_HEIGHT;
    _bubbleRadius = 10;
...
- (void)updateFrameForLeftNavigationItem {
    ...
    if (_againstStatusBar && _headerHidden) leftFrame.origin.y += VTSTATUSBAR_HEIGHT * 0.5;
...
- (void)updateFrameForRightNavigationItem {
    ...
    if (_againstStatusBar && _headerHidden) rightFrame.origin.y += VTSTATUSBAR_HEIGHT * 0.5;
