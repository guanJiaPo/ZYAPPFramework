...
- (instancetype)init
{
    ...
    if (self) {
        self.arrowSize = CGSizeMake(10.0, 12.0);
...
- (void)setApplyShadow:(BOOL)applyShadow
{
    ...
    if (_applyShadow) {
        self.layer.shadowColor = [UIColor colorWithRed:0.1506 green:0.1506 blue:0.1506 alpha:0.1].CGColor;
...
- (void)drawRect:(CGRect)rect
{
    ...
    switch (self.popoverPosition) {
        case DXPopoverPositionDown: { // 箭头朝下的时候
            ...
            break;
        case DXPopoverPositionUp: { // 箭头朝上的时候
